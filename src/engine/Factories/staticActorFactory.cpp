#include "../include/engine/Factories/staticActorFactory.h"

StaticActorFactory::StaticActorFactory(){
    matFactory = new MaterialFactory();
    collisionBoxFactory = new CollisionBoxFactory();
}

StaticActor* StaticActorFactory::CreateStaticActorFromXML(std::string fileName){
    ...
    if(!filePath.empty()){
        ...
        StaticActor* obj = new StaticActor(name, mat, vertices, texCoords, indices);
